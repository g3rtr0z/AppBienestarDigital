...
export const HydrationReminder: React.FC = () => {
  const [waterIntake, setWaterIntake] = React.useState<number>(4);
  const [nextReminder, setNextReminder] = React.useState<number>(45);
      ...
      setNextReminder((prev) => {
        if (prev <= 1) {
          addNotification({
            ...
            message: "Recuerda tomar un vaso de agua para mantenerte hidratado.",
            type: "info",
            read: false
          });
          return 45;
